...
- - [Install ELK](Ansible/install-elk.yml) - Installs ELK Container on 10.1.0.4/20.127.31.165 to enable the use of Kibana
  - [Install DVWA](Ansible/dvwa_install.yml) - Installs DVWA Container on 10.0.0.5, 10.0.0.6, 10.0.0.7 (All 3 Web VMs) to enable to the use of Damn Vulnerability Web 
...
- - [ELK](Ansible/install-elk.yml) - Enable the use of Kibana server on browser to view the logs generated by filebeat and metricbeat
  - [DVWA](Ansible/dvwa_install.yml) - Enables the use of Damn Vulnerability Web Access page on 20.9.54.192 website.
